...
#        print('width height', self.vid.width, self.vid.height)
        ...
        self.btn_face_neutral, self.btn_face_happy, self.btn_face_unsure, self.btn_face_sad, self.btn_face_angry = None, None, None, None, None
#        self.btn_pause_r, self.btn_pause_g, self.btn_pause_value = None, None, 0
        ...
        self.mmenu = [[self.btn_demo_r,   self.btn_demo_g,   "Demo",            self.set_demo_value],
                      ...
                      [self.btn_quit,     None,              "Quit",            self.quit_command]]
        self.mainmenu()
    ...
    def button(self, menu_list, i, val, txt=None):
        ...
        if menu_list[i][num1] is None:
            menu_list[i][num1] = Tkinter.Button(self.window, width=self.btnwidth, height=self.btnheight, #wraplength=150, 
    ...
    def menu_buttons(self, menu_list, submenu):
        for i in range(len(menu_list)):
            ...
            if menu_list[i][num] is None:
                menu_list[i][num] = Tkinter.Button(self.window, width=self.btnwidth, height=self.btnheight, #wraplength=80,
                                                fg="white", bg=color, activebackground=color, font=self.fonttype,
                                                text=txt, command=menu_list[i][3])
#            menu_list[i][0].place(y=self.btnypos_list[i], anchor="nw", bordermode="outside")
    ...
    '''
    def set_caption_value(self): # method tied to "Caption" button

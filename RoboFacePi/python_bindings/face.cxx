...
*/
    class_<Face>("Face", "One must create an instance of this class "
        ...
        .def("neutral", &Face::neutral, (arg("moveHead") = true,arg("movelips") = true),
                "neutral facial expression with optional head movement")
        .def("unsure", &Face::unsure, (arg("moveHead") = true,arg("movelips") = true),
                "unsure facial expression with optional head movement")
        .def("happy", &Face::happy, (arg("moveHead") = true,arg("movelips") = true),
                "happy facial expression with optional head movement")
        .def("angry", &Face::angry, (arg("moveHead") = true,arg("movelips") = true),
                "angry facial expression with optional head movement")
        .def("sad", &Face::sad, (arg("moveHead") = true,arg("movelips") = true),
